        ...
        <table class="contacts" border="1">
            ...
            <?php foreach ($contacts as $contact): ?>
                <tr>
                    ...
                    <td><a href="index.php?op=update&id=<?php print $contact->id; ?>&na=<?php print $contact->name; ?>&ph=<?php print $contact->phone; ?>&em=<?php print $contact->email; ?>&add=<?php print $contact->address; ?>">Update</a></td>
                </tr>
            <?php endforeach; ?>
            </tbody>
        </table>
